...
const WIKI_LINKS = [
	{ name: 'lastepoch.wiki', url: 'https://www.lastepoch.wiki' },
			...
			<div className="container mx-auto px-4 py-4">
				<div className="flex items-center justify-between">
					...
					>
						...
						<span className="font-bold text-lg hidden sm:inline">CookieRun: OvenSmash</span>
						<span className="font-bold text-lg sm:hidden">CROS</span>
					</Link>
