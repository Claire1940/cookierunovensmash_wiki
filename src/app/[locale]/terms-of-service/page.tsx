...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - CookieRun: OvenSmash Wiki",
    description: "Read the Terms of Service for CookieRun: OvenSmash Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our mobile game resource platform.",
    keywords: [
      'terms of service',
      "CookieRun: OvenSmash Wiki terms",
      'user agreement',
      'legal terms',
      'usage policy',
    ],
    ...
    openGraph: {
      ...
      title: "Terms of Service - CookieRun: OvenSmash Wiki",
      description: "Terms and conditions for using CookieRun: OvenSmash Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using CookieRun: OvenSmash Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using CookieRun: OvenSmash Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and CookieRun: OvenSmash Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              CookieRun: OvenSmash Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the mobile game "CookieRun: OvenSmash" by Devsisters. Our services include, but are not limited to:
            </p>
            <ul>
              <li>Cookie guides and tier lists</li>
              <li>Build and spell card guides</li>
              <li>Battle mode information and strategies</li>
              <li>Redemption codes and events</li>
              <li>Beginner tips and walkthroughs</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> CookieRun: OvenSmash Wiki is NOT affiliated with, endorsed by, or associated with
              Devsisters Corporation or the official developers of CookieRun: OvenSmash. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by CookieRun: OvenSmash Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Devsisters Corporation and/or the developers of CookieRun: OvenSmash. We use such
            ...
            <ul>
              ...
              <li><strong>App Availability:</strong> App availability and game updates may change without notice. We are not responsible for app access or game changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, COOKIE RUN: OVENSMASH WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including Google Play, App Store, Discord, social media platforms,
            ...
            <p>
              ...
              you and CookieRun: OvenSmash Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@cookierunovensmash.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@cookierunovensmash.wiki</a>
            </p>
            <p>
