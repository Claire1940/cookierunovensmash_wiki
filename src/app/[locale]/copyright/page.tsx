...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - CookieRun: OvenSmash Wiki',
    description: 'Copyright and intellectual property information for CookieRun: OvenSmash Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    keywords: [
      'copyright notice',
      'CookieRun: OvenSmash Wiki copyright',
      'DMCA policy',
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - CookieRun: OvenSmash Wiki',
      description: 'Copyright and intellectual property information for CookieRun: OvenSmash Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 CookieRun: OvenSmash Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of CookieRun: OvenSmash Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              CookieRun: OvenSmash Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Devsisters Corporation</strong> - Developers of CookieRun: OvenSmash</li>
            </ul>
            <p>
            ...
            <ul>
              <li><strong>CookieRun: OvenSmash</strong> - Trademark of Devsisters Corporation</li>
              <li><strong>CookieRun: OvenSmash Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with CookieRun: OvenSmash Wiki.
            </p>
            ...
            <p>
              ...
              CookieRun: OvenSmash Wiki<br />
              Email: <a href="mailto:dmca@cookierunovensmash.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@cookierunovensmash.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "CookieRun: OvenSmash Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: CookieRun: OvenSmash Wiki (cookierunovensmash.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@cookierunovensmash.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@cookierunovensmash.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@cookierunovensmash.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@cookierunovensmash.wiki</a>
            </p>
            <p>
